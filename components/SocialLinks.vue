<template>
  <div class="flex items-center">
    <a
      class="link mr-6"
      href="https://github.com/bhushan"
      target="_blank"
    >
      <svg
        class="h-6 fill-current text-gray-500 hover:text-blue-700"
        role="img"
        viewBox="0 0 24 24"
    ...
    <a
      class="link mr-6"
      href="https://twitter.com/rckstrbhushan"
      target="_blank"
    >
      <svg
        class="h-6 fill-current text-gray-500 hover:text-blue-700"
    ...
    <a
      class="link mr-6"
      href="https://www.linkedin.com/in/rckstrbhushan/"
      target="_blank"
    >
      <svg
        class="h-6 fill-current text-gray-500 hover:text-blue-700"
    ...
    <a
      class="link mr-6"
      href="https://dribbble.com/bhushang"
      target="_blank"
    >
      <svg
        class="h-6 fill-current text-gray-500 hover:text-blue-700"
    ...
    <a
      class="link mr-6"
      href="https://youtube.com/channel/UCjJJcMm6gIC1gQnhEhTBjDA"
      target="_blank"
    >
      <svg
        class="h-6 fill-current text-gray-500 hover:text-blue-700"
